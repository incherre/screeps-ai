...
export class PickupRequest extends ScreepsRequest {
    ...
    public container: Structure | Resource | Tombstone;

    public getType(): string {
        return PickupRequest.type;
    }

    constructor (requester: string, container: Structure | Resource | Tombstone, resourceType: ResourceConstant = RESOURCE_ENERGY) {
        super();
